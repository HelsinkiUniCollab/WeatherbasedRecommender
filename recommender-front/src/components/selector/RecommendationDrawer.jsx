...
function SettingsSelector({ poiData, onRecChoice, userPosition, timeValue,
  ...
  return (
    <div className="preference-selector-container">
      ...
      <Typography variant="h7" onClick={toggleDrawer(true)}>Recs</Typography>
